...
class ColocationTasklistScreen extends StatefulWidget {
  ...
  const ColocationTasklistScreen({super.key, required this.colocationId});

  static const routeName = '/colocation/task-list';

  @override
  State<ColocationTasklistScreen> createState() => _ColocationTasklistScreenState();
}
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text(
                'Colocation name . ${widget.colocationId}', // todo Remplacer par le nom de la coloc
              ...
              actions: [
                IconButton(
                    onPressed: () {}, // todo rediriger sur le screen pour les settings de la colocation
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: IconButton(
                                            onPressed: () {}, // todo rediriger sur le détails d'une tâches
